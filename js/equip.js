...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const equipmentData = [
    {
      ...
      name: 'Гантели',
      description:
        'Самый универсальный силовой инвентарь для домашних и зальных тренировок. Развивают мышцы рук, груди, плеч и всего тела.',
    ...
    },
    {
      ...
      name: 'Фитнес браслет',
      description:
        'Умный гаджет для отслеживания активности, пульса, сна и тренировочного прогресса. Синхронизируется со смартфоном.',
    ...
    },
    {
      ...
      name: 'Йога-мат',
      description:
        'Толстый нескользящий коврик для йоги, пилатеса и домашних тренировок с высокой амортизацией и поддержкой позвоночника.',
    ...
    },
    {
      ...
      name: 'Уличный турник',
      description:
        'Прочный уличный тренажер для воркаута, установки во дворе или на спортивной площадке. Развивает силу и выносливость.',
  ...
  function renderEquipment() {
    ...
    if (currentFilter !== 'all') {
      filteredData = equipmentData.filter(
